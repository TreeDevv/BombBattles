...
local offensiveCatalog = table.freeze({
	...
	{ id = "HeavenFire", displayName = "Heaven Fire", inventoryTextStyleKey = "HEAVEN FIRE", iconAssetId = "122161462244434" },
...
local abilityPurchaseMetadata = table.freeze({
	...
	HeavenFire = table.freeze({ rarity = "Divine", purchaseKind = AbilityConfig.PurchaseKinds.Coins, price = 25000 }),
...
local extraDefinitions = {
	...
	JumpPad = {
		description = "Place a reusable launch pad that springs players into the air.",
		rarity = "Common",
		cooldownSeconds = 12,
		durationSeconds = 0,
		maxClientMessagesPerSecond = 8,
		hookPriority = 0,
		assetPath = table.freeze({ "Assets", "Abilities", "JumpPad", "JumpPad" }),
		placementDistance = 8,
		floorRaycastUp = 8,
		floorRaycastDown = 140,
		minFloorNormalY = 0.5,
		lifetimeSeconds = 8,
		triggerCooldownSeconds = 0.65,
		verticalLaunchVelocity = 95,
		horizontalLaunchSpeed = 48,
		airControlSource = "JumpPad",
		airControlMinAirTime = 0.24,
		dropMaxHeight = 32,
		dropSpeed = 72,
		dropMinSeconds = 0.12,
		dropMaxSeconds = 0.45,
		springCompressedClearance = 0.08,
		springRestingHeightOffset = 0.5,
		springUpSeconds = 0.12,
		springHoldSeconds = 0.08,
		springRecompressSeconds = 0.16,
		fadeSeconds = 0.25,
		cameraPunchDuration = 0.18,
		cameraPunchFOVBonus = 2.6,
		placeholder = false,
		replicatedState = table.freeze({
			padsPlaced = 0,
			lastPlacedAt = 0,
	...
	ShockAbsorber = {
		description = "Reduce incoming bomb damage and enemy knockback for 5 seconds.",
		rarity = "Common",
		cooldownSeconds = 14,
		durationSeconds = 5,
		maxClientMessagesPerSecond = 8,
		hookPriority = 0,
		assetPath = table.freeze({ "Assets", "Abilities", "ShockAbsorber", "ShockAbsorber", "Rig" }),
		damageMultiplier = 0.5,
		knockbackMultiplier = 0.5,
		activeUntilAttribute = "ShockAbsorber_ActiveUntil",
		visualFadeSeconds = 0.18,
		particleCleanupSeconds = 1.1,
		placeholder = false,
		replicatedState = table.freeze({
			activationCount = 0,
			lastActivatedAt = 0,
	...
	AirBurst = {
		...
		maxClientMessagesPerSecond = 8,
		verticalVelocity = 80,
		minAirborneUpwardDelta = 42,
		maxAirborneVerticalVelocity = 110,
	...
	GrappleHook = {
		...
		maxRange = 375,
		projectileSpeed = 410,
		hookTravelMaxSeconds = 0.58,
		missCooldownSeconds = 2,
		minAnchorDistance = 8,
		latencyGraceSeconds = 0.35,
		pendingVisualTimeoutSeconds = 1.15,
		playerPullSpeed = 145,
		playerMinPullSpeed = 72,
		playerMaxPullSpeed = 160,
		playerPullAcceleration = 250,
		playerInitialPullBoost = 26,
		playerSteerAcceleration = 105,
		playerMaxSteerSpeed = 36,
		playerTangentialRetention = 0.92,
		playerMaxTangentialSpeed = 74,
		playerUpwardBias = 24,
		wallAssistMaxNormalY = 0.45,
		wallAssistStandOff = 4.5,
		wallAssistLift = 4.25,
		releaseUpwardVelocity = 52,
		releaseForwardVelocity = 84,
		releaseMomentumScale = 1,
		releaseMaxSpeed = 122,
		releaseWallKickSpeed = 36,
		releaseWallKickMaxDistance = 11,
		releaseWallKickIntoWallDot = 0.35,
		playerArrivalDistance = 8.5,
		playerMaxPullTime = 1.65,
		enemyPullSpeed = 95,
		enemyUpwardBias = 14,
	...
	GravityBoots = {
		description = "Activate low-gravity boots that reduce knockback and give strong air control for a short duration.",
		cooldownSeconds = 12,
		durationSeconds = 5,
		maxClientMessagesPerSecond = 8,
		hookPriority = 0,
		...
		assetPath = table.freeze({ "Assets", "Abilities", "GravityBoots", "GravityBoots" }),
		airSteeringScale = 2.25,
		airBrakeScale = 1.8,
		airGravityScaleMultiplier = 0.5,
	...
	OrbitalStrike = {
		...
		terrainColumnMaxTargetsPerStep = 32,
	...
	HeavenFire = {
		description = "Mark an area and call down a delayed heavenly explosion from above.",
		rarity = "Divine",
		cooldownSeconds = 60,
		durationSeconds = 0,
		maxClientMessagesPerSecond = 16,
		hookPriority = 0,
		assetPath = table.freeze({ "Assets", "Abilities", "HeavenFire", "HeavenFire" }),
		cameraAssetPath = table.freeze({ "Assets", "Abilities", "HeavenFire", "Camera" }),
		strikeDelay = 1.35,
		impactExplosionDelaySeconds = 3.4,
		impactExplosionRadius = 32,
		impactInnerRadius = 12,
		impactMediumRadius = 24,
		impactInnerDamage = 115,
		impactMediumDamage = 80,
		impactOuterDamage = 40,
		impactKnockbackHorizontal = 130,
		impactKnockbackVertical = 80,
		impactKnockbackMinScale = 0.25,
		impactDebrisMaxParts = 48,
		impactExplosionMaxTargets = 72,
		terrainTransparentCollisionClearance = 8,
		cameraHeight = 110,
		targetFOV = 40,
		placementPanSpeed = 180,
		cameraShakeRadius = 260,
		cameraShakeMagnitude = 1.8,
		cameraShakeRoughness = 8,
		cameraShakeFadeInTime = 0.03,
		cameraShakeFadeOutTime = 0.35,
		cameraShakePositionInfluence = Vector3.new(0.12, 0.08, 0.12),
		cameraShakeRotationInfluence = Vector3.new(0.45, 0.25, 0.4),
		blackFlashRadius = 260,
		blackFlashDuration = 3,
		blackFlashHitDuration = 3,
		blackFlashClosestTransparency = 0.3,
		warningLifetimeSeconds = 1.6,
		warningFinalPulseSeconds = 0.22,
		strikeVisualCleanupSeconds = 5,
		cameraVfxDurationSeconds = 3,
		totalPlayerDamage = 115,
		totalCoreDamage = 0,
		placeholder = false,
		replicatedState = table.freeze({
	...
	Infinity = {
		description = "Surround yourself with infinity, becoming untouchable while nearby bombs crawl through space.",
		rarity = "Divine",
		cooldownSeconds = 40,
		durationSeconds = 6,
		maxClientMessagesPerSecond = 8,
		hookPriority = 4,
		assetPath = table.freeze({ "Assets", "Abilities", "Infinity", "Infinity" }),
		bubbleAssetPath = table.freeze({ "Assets", "Abilities", "Infinity", "Infinity", "Bubble" }),
		rigEffectsAssetPath = table.freeze({ "Assets", "Abilities", "Infinity", "Infinity", "RigEffects" }),
		activeUntilAttribute = "Infinity_ActiveUntil",
		blockPulseThrottleSeconds = 0.16,
		radius = 20,
		innerRadius = 6,
		minTimeScale = 0.03,
		timeScaleEnterRate = 7.5,
		timeScaleExitRate = 5.5,
		timeScaleCurvePower = 2.35,
		startScale = 0.08,
		growthSeconds = 0.24,
		fadeOutSeconds = 0.25,
		pulseSeconds = 0.52,
		pulseScale = 1.025,
		visualColor = Color3.fromRGB(65, 235, 255),
		visualTransparency = 0.82,
		projectileTintColor = Color3.fromRGB(65, 235, 255),
		projectileHighlightFillTransparency = 0.2,
		projectileHighlightOutlineTransparency = 0.02,
		particleCleanupSeconds = 1.4,
		placeholder = false,
		replicatedState = table.freeze({
			activationCount = 0,
			blocks = 0,
	...
	EmergencyFort = {
		...
		maxClientMessagesPerSecond = 8,
		hookPriority = 0,
		assetPath = table.freeze({ "Assets", "Abilities", "EmergencyFort", "EmergencyFort" }),
		floorRaycastUp = 8,
		floorRaycastDown = 32,
		minFloorNormalY = 0.2,
		fortHealth = 500,
		...
		doorTriggerRadius = 8,
		doorCheckSeconds = 0.12,
		doorOpenOffset = 10.5,
		doorTweenSeconds = 0.22,
		doorOpenSoundName = "Open",
		doorCloseSoundName = "Close",
	...
	AbsorbShield = {
		description = "Cover your body in a forcefield. Absorb one enemy bomb explosion and empower your next bomb.",
		rarity = "Rare",
		cooldownSeconds = 18,
		durationSeconds = 7,
		maxClientMessagesPerSecond = 8,
		hookPriority = 22,
		assetPath = table.freeze({ "Assets", "Abilities", "AbsorbShield", "AbsorbShield" }),
		radius = 4.25,
		empoweredBombScale = 1.5,
		empoweredMaxTargetsPerExplosion = 72,
		empowerDurationSeconds = 180,
		startScale = 0.35,
		growthSeconds = 0.18,
		fadeOutSeconds = 0.18,
		absorbFlashSeconds = 0.12,
		absorbCollapseSeconds = 0.18,
		pulseSeconds = 0.75,
		pulseScale = 1.04,
		visualTransparency = 0.9,
		vfxColor = Color3.fromRGB(255, 81, 2),
		highlightFillTransparency = 0.58,
		highlightOutlineTransparency = 0.05,
		highlightPulseFillTransparency = 0.25,
		placeholder = false,
		replicatedState = table.freeze({
			activationCount = 0,
			absorbs = 0,
			empoweredBombsThrown = 0,
			lastActivatedAt = 0,
			lastAbsorbedAt = 0,
			lastEmpoweredAt = 0,
		}),
