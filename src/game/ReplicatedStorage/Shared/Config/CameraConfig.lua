return table.freeze({
	...
	HeadLockedCameraSubjectEnabled = false,
	HeadLockedSubjectPartName = "Head",
	HeadInfluenceEnabled = true,
	HeadInfluencePartName = "Head",
	HeadInfluenceResponsiveness = 7,
	HeadInfluenceScale = 0.65,
	HeadInfluenceMaxLocalOffset = Vector3.new(0.16, 0.12, 0.16),
