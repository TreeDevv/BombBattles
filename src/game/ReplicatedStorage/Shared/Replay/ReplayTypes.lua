...
Expected shape for replay map reconstruction:
{
	...
	maxTargetsPerExplosion: number?,
	forceSubtract: boolean?,
	transparentCollisionClearance: number?,
	exactCullTargets: boolean?,
	skipTerminalNoop: boolean?,
	reuseTargetPart: boolean?,
	prefilterTargets: boolean?,
	prefilteredTargets: boolean?,
	debrisPayloads: {
		{
			compact: boolean?,
