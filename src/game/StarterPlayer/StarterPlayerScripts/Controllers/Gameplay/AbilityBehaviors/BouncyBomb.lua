...
local BouncyBomb = {} :: AbilityTypes.ClientBehavior
BouncyBomb.HandlesInputState = true
...
function BouncyBomb.OnActivateRequested(context: ClientActivateRequestedContext): boolean
...
function BouncyBomb.OnEffect(_context: ClientEffectContext)
end
