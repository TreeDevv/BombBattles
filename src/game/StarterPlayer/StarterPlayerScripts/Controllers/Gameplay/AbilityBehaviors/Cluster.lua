...
local Cluster = {} :: AbilityTypes.ClientBehavior
Cluster.HandlesInputState = true
...
function Cluster.OnActivateRequested(context: ClientActivateRequestedContext): boolean
...
function Cluster.OnEffect(_context: ClientEffectContext)
end
