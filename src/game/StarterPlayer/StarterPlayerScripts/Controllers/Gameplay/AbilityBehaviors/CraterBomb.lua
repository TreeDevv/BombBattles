...
local CraterBomb = {} :: AbilityTypes.ClientBehavior
CraterBomb.HandlesInputState = true
...
function CraterBomb.OnActivateRequested(context: ClientActivateRequestedContext): boolean
