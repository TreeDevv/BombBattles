...
local FastFuse = {} :: AbilityTypes.ClientBehavior
FastFuse.HandlesInputState = true
...
function FastFuse.OnActivateRequested(context: ClientActivateRequestedContext): boolean
...
function FastFuse.OnEffect(_context: ClientEffectContext)
end
