...
local MegaBomb = {} :: AbilityTypes.ClientBehavior
MegaBomb.HandlesInputState = true
...
local function updatePreview()
	...
	local color = getDefinitionColor(definition, "previewColor", BombConfig.PreviewDangerColor)
...
function MegaBomb.OnActivateRequested(context: ClientActivateRequestedContext): boolean
...
function MegaBomb.OnEffect(_context: ClientEffectContext)
end
