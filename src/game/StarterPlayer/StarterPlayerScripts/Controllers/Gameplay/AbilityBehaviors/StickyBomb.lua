...
local StickyBomb = {} :: AbilityTypes.ClientBehavior
StickyBomb.HandlesInputState = true
...
function StickyBomb.OnActivateRequested(context: ClientActivateRequestedContext): boolean
...
function StickyBomb.OnEffect(_context: ClientEffectContext)
end
